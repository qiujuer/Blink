...
import net.qiujuer.blink.ReceiveDelivery;
import net.qiujuer.blink.ReceiveEntity;
import net.qiujuer.blink.ReceiveParser;
import net.qiujuer.blink.Receiver;
import net.qiujuer.blink.SendDelivery;
import net.qiujuer.blink.SendEntity;
import net.qiujuer.blink.Sender;
...
public class SocketAdapter implements Sender, Receiver {
	...
	@Override
	public ReceiveEntity<?> receiveHead() {
		try {
			int type = mIn.read();
			if (type != -1) {
				...
				ReceiveEntity<?> entity = mParser.parseReceive(type, len);
				if (entity == null)
					receiveRedundancy();
				return entity;
			}
	 ...
	 */
	@Override
	public boolean receiveEntity(ReceiveEntity<?> entity,
	 ...
	 */
	@Override
	public boolean sendHead(SendEntity entity) {
	 ...
	 */
	@Override
	public boolean sendEntity(SendEntity entity, SendDelivery delivery) {
		int cursor = 0;
