...
public abstract class Connector implements Disposable {
     ...
     * @return Connector
     */
    protected Connector setSender(Sender sender) {
        mSender = sender;
        return this;
    }
     ...
     * @return Connector
     */
    protected Connector setReceiver(Receiver receiver) {
        mReceiver = receiver;
        return this;
    }
     ...
     * @return Connector
     */
    protected Connector setConnectDelivery(ConnectDelivery connectDelivery) {
     ...
     * @return Connector
     */
    protected Connector setReceiveDelivery(ReceiveDelivery receiveDelivery) {
     ...
     * @return Connector
     */
    protected Connector setSendDelivery(SendDelivery sendDelivery) {
     ...
     * @return Connector
     */
    protected Connector setSendDispatcher(SendDispatcher sendDispatcher) {
     ...
     * @return Connector
     */
    protected Connector setReceiveDispatcher(ReceiveDispatcher receiveDispatcher) {
     ...
     */
    protected void deliveryReceiveStart(ReceivePacket packet) {
     ...
     */
    protected void deliveryReceiveProgress(ReceivePacket packet, float progress) {
        if (mReceiveListener != null)
     ...
     * @param packet ReceivePacket
     */
    protected void deliveryReceiveCompleted(ReceivePacket packet) {
        if (mReceiveListener != null)
